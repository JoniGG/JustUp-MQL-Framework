...
const double speedOfSound20C = 331.45;
const double speedOfSound15C = 330.0;
const double speedOfSound0C = 328.15;
const double speedOfSoundMinus15C = 326.0;
const double speedOfSoundMinus20C = 324.15;
const double onePip = 0.0001;
const double onePipInPips = 0.01;
const double onePipInPoints = 0.1;
const double onePipInTicks = 10;
const double onePipInCents = 1;
const double onePipInDollars = 0.0001;
